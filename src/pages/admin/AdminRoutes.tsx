    ...
    <>
      ...
      <Routes>
        <Route element={<AppLayout />}>
          ...
          <Route path="Rifas/crear" element={<RifaFormPage />} />
          <Route path="Rifas/editar/:uuidPublico" element={<RifaFormPage />} />

          <Route path="resultados/loteria" element={<ResultadosLoteria />} />
          <Route path="resultados/rifas" element={<ResultadosRifas />} />
